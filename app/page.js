        ...
        <div className="hidden md:flex">
          <nav>
            <ul className="flex space-x-8">
              ...
              <li>
                <Link href="/pets" className="text-white hover:text-blue-500 transition duration-200 text-lg font-medium">
                  Pets
                </Link>
              </li>
              <li>
                <Link href="/support" className="text-white hover:text-blue-500 transition duration-200 text-lg font-medium">
                  Support
                </Link>
              </li>
            </ul>
        ...
        >
          <div className="flex justify-center items-center mb-4">
            <p className="text-green-400 text-sm font-medium flex items-center">
              ...
              41 NEW PETS REGISTERED THIS WEEK!
            </p>
          </div>
